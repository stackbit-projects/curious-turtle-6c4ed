...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fc6c4ed90a4390015cb964f
...
To start editing your site, you can use the Sanity interface at https://curious-turtle-6c4ed.sanity.studio/.
...
Generated at `2020-12-01T22:37:22.235Z` by Stackbit version `0.3.38`.